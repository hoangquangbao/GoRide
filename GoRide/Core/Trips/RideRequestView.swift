            ...
            HStack {
                VStack(alignment: .leading, spacing: 5) {
                    ...
                    HStack {
                        ...
                        if let selectedGorideLocation = vm.selectedGorideLocation?.title {
                    ...
                    HStack {
                        ...
                        Text((vm.tripDistanceInKilometers ?? 0.00).toDistanceInKilometers())
                    }
                    .font(.system(.subheadline))
                }
            }
                    ...
                    ForEach(RideType.allCases, id: \.self) { type in
                        VStack(alignment: .center) {
                            ...
                            Group {
                                ...
                                Text(vm.computeRidePrice(forType: type).toCurrency())
                            }
